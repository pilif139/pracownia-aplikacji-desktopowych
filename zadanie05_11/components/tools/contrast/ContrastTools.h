...
public:
    ...
    static void applyLinear(QImage& image, double contrast);
    ...
    static void applyLogarithmic(QImage& image, double k);
    ...
    static void applyExponential(QImage& image, double k);
};
